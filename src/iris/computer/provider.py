...
`iris.computer` never costs a browser stack that most installs do not have.
"""
...
from iris.computer.actions import Action, ActionKind, Observation
...
def provider_from_settings() -> ComputerProvider:
    ...
    """
    # Imported here so `iris.computer` stays importable without settings being
